function [R_pos, R_neg, R_comb, pos_mask, neg_mask, comb_mask] = BehavPred_100TestTrainSplit(split,sidx,all_mats,all_behav,THR,no_sub,no_node);

% Edited by Hamdi Eryilmaz on 6/1/23 
...
% involving 100 train-test splits

%% Get training and test participants for the current split

trainCUTOFF = round(0.7*no_sub); % 70% train 30% test 
...
% Initialize predictions for positive, negative and combined sets
