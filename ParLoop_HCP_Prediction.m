% Created by Hamdi Eryilmaz on 3/1/23
...
parfor i=1:NSPLIT
    disp(i)
    [pred_acc_pos(i), pred_acc_neg(i), pred_acc_comb(i), all_pos_mask(:,:,i), all_neg_mask(:,:,i), all_comb_mask(:,:,i)] = BehavPred_100TestTrainSplit(split,i,all_mats,all_behav,0.01,no_sub,no_node);
end
